...
class HarvestAgent(Agent):
    ...
    @remaining_timeout.setter
    def remaining_timeout(self, neq_remaining_timeout):
        self._remaining_timeout = neq_remaining_timeout
        if neq_remaining_timeout < 0:
            self._remaining_timeout = 0
